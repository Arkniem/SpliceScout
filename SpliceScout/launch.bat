...
echo ============================================================
echo   GEO RNA-seq Pipeline - launcher
...
echo.
echo Python was installed. Please CLOSE this window and double-click launch.bat again
...
echo IMPORTANT: tick "Add python.exe to PATH" during setup, then run launch.bat again.
echo.
pause
exit /b 1
